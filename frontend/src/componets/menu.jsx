    ...
    return (
        <nav className="navbar navbar-expand-lg" style={{ backgroundColor: "#f3e5f5" }}>
            <div className="container-fluid">
                <Link className="navbar-brand" href="/" style={{ color: "#800080", fontWeight: "bold" }}>
                    Mi Aplicación
                </Link>
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        <li className="nav-item">
                            <Link className="nav-link active" href="/" style={{ color: "#6a1b9a" }}>
                                Inicio
                            </Link>
                        </li>
                        <li className="nav-item dropdown">
                            <Link className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" style={{ color: "#6a1b9a" }}>
                                Usuarios
                            </Link>
                            <ul className="dropdown-menu" style={{ backgroundColor: "#f3e5f5" }}>
                                <li>
                                    <Link className="dropdown-item" href="/usuarios/mostrar" style={{ color: "#800080" }}>
                                        Mostrar
                                    </Link>
                                </li>
                                <li>
                                    <Link className="dropdown-item" href="/usuarios/nuevo" style={{ color: "#800080" }}>
                                        Crear
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu" style={{ backgroundColor: "#f3e5f5" }}>
                                <li>
                                    <Link className="dropdown-item" href="/productos/mostrar" style={{ color: "#800080" }}>
                                        Mostrar
                                    </Link>
                                </li>
                                <li>
                                    <Link className="dropdown-item" href="/productos/nuevo" style={{ color: "#800080" }}>
                                        Crear
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu" style={{ backgroundColor: "#f3e5f5" }}>
                                <li>
                                    <Link className="dropdown-item" href="/ventas/mostrar" style={{ color: "#800080" }}>
                                        Mostrar
                                    </Link>
                                </li>
                                <li>
                                    <Link className="dropdown-item" href="/ventas/nuevo" style={{ color: "#800080" }}>
                                        Crear
                                    </Link>
                                </li>
                            </ul>
